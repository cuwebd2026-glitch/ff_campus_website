...
export function TournamentIntro() {
  return (
    <section id="tournament" className="cc-section cc-intro">
      <Reveal>
        <SectionHeading code="01 / TOURNAMENT" title={<>ONE CUP.<br /><span>TWO BATTLEGROUNDS.</span></>} side="THE ROAD TO COMPETITION" />
      </Reveal>
      <div className="cc-intro-map">
        <Reveal className="cc-intro-level national">
          ...
          <div>
            ...
            <p>Campus Cup Season 2 brings collegiate competitors into a wider national tournament journey.</p>
          </div>
        ...
        <Reveal className="cc-intro-level campus" delay={0.15}>
          ...
          <div>
            ...
            <p>The Chandigarh University event is a distinct college qualifier, organized locally by GFG Community at CU.</p>
          </div>
