...
const stages = [
  [
    ...
    "REGISTRATION",
    "Details pending",
    "Registration opening and closing times to be confirmed.",
  ],
  [
    "02",
    "CHECK-IN",
    "14 Sep · Time TBA",
    "Team verification and lobby reporting instructions pending.",
  ],
