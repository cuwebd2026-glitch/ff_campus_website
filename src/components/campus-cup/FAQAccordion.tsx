...
const faqs = [
  [
    ...
    "Official eligibility criteria have not yet been confirmed by the organizer.",
  ],
  [
    "How many players can be on a team?",
    "Roster size and substitution rules are awaiting the official tournament brief.",
  ],
  ...
  [
    ...
    "Device, account, and game-version requirements will be included in the confirmed rules.",
  ],
  [
    "Where will updates be announced?",
    "The organizer’s official update channel has not yet been supplied.",
  ],
];
