...
const overviewItems = [
  ...
  },
  {
    ...
    note: "Awaiting organizer details",
  },
  ...
  { icon: Swords, code: "EVENT FORMAT", value: "TO BE CONFIRMED", note: "Match format pending" },
  {
    icon: ShieldCheck,
    code: "PARTICIPATION",
    value: "OFFICIAL BRIEF PENDING",
    note: "Check back for instructions",
  },
];
      ...
      <div className="cc-overview-grid">
        {overviewItems.map((item, i) => (
          <Reveal
            key={item.code}
            delay={i * 0.04}
            className={cn("cc-info-block", i < 2 && "confirmed")}
          >
