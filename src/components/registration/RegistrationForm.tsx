          ...
          <div className="victory-ticket relative border-2 border-amber/70 bg-surface-deep p-6 text-center cc-ticket-shimmer shadow-[0_0_30px_rgba(230,170,40,0.2)] rounded-sm">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-1.5 border border-amber/60 bg-card px-3 py-2 font-display text-xs font-bold uppercase tracking-wider text-foreground hover:bg-amber hover:text-black transition-all duration-200 cursor-pointer active:scale-95"
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-2 w-full">
                ...
                <span
                  className={`font-display text-xs font-black uppercase tracking-wider transition-colors ${
              ...
              <span className="font-body text-[10px] text-muted-foreground mt-1 hidden sm:block">
                {s.desc}
              </span>
            </div>
          );
          ...
          <div className="space-y-6">
            ...
            <div className="pt-2">
              {members.length < 5 ? (
                ...
                <div className="w-full py-3 px-4 rounded-sm border border-white/10 bg-black/40 text-muted-foreground text-center font-mono text-xs uppercase">
